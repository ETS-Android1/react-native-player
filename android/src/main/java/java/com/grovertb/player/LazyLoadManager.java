...
import com.grovertb.player.SoInstaller;
...
public class LazyLoadManager extends IntentService {
    ...
    private void error(String message) {
        ...
        if (lastFingprint != null) {
            com.grovertb.player.GiraffePlayer player = com.grovertb.player.PlayerManager.getInstance().getPlayerByFingerprint(lastFingprint);
            if (player != null) {
    ...
    private void installSo(File soDir) throws Exception {
        SoInstaller.installNativeLibraryPath(com.grovertb.player.GiraffePlayer.class.getClassLoader(), soDir);
    ...
    private void sendLastMessage() {
        com.grovertb.player.GiraffePlayer player = PlayerManager.getInstance().getPlayerByFingerprint(lastFingprint);
        if (player != null) {
