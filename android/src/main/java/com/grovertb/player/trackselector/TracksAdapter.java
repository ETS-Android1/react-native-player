package com.grovertb.player.trackselector;
...
import com.grovertb.player.trackselector.TrackGroup;
import com.grovertb.player.trackselector.TrackInfoWrapper;
...
public class TracksAdapter extends BaseExpandableListAdapter {
    ...
    private Map<Integer, com.grovertb.player.trackselector.TrackGroup> dataIndex = new HashMap<>();
    private List<com.grovertb.player.trackselector.TrackGroup> data = new ArrayList<>();
    ...
    @Override
    public com.grovertb.player.trackselector.TrackGroup getGroup(int groupPosition) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        com.grovertb.player.trackselector.TrackGroup group = getGroup(groupPosition);
        if (convertView == null) {
        ...
        if (convertView == null) {
            ...
            convertView.findViewById(R.id.app_video_track_group_child).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    com.grovertb.player.trackselector.TrackGroup trackGroup = dataIndex.get(track.getTrackType());
    ...
    public void load(String fingerprint) {
        ...
        for (int i = 0; i < tracks.length; i++) {
            ...
            if (trackType == ITrackInfo.MEDIA_TRACK_TYPE_AUDIO ||
                ...
                com.grovertb.player.trackselector.TrackGroup trackGroup = dataIndex.get(trackType);
                if (trackGroup == null) {
