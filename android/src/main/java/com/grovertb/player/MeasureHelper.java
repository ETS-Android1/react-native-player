...
public final class MeasureHelper {
    ...
    private int mCurrentAspectRatio = com.grovertb.player.VideoInfo.AR_ASPECT_FIT_PARENT;
    ...
    public void doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mCurrentAspectRatio == com.grovertb.player.VideoInfo.AR_MATCH_PARENT) {
            ...
            if (widthSpecMode == View.MeasureSpec.AT_MOST && heightSpecMode == View.MeasureSpec.AT_MOST) {
                ...
                switch (mCurrentAspectRatio) {
                    case com.grovertb.player.VideoInfo.AR_16_9_FIT_PARENT:
                        displayAspectRatio = 16.0f / 9.0f;
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case com.grovertb.player.VideoInfo.AR_4_3_FIT_PARENT:
                        displayAspectRatio = 4.0f / 3.0f;
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case com.grovertb.player.VideoInfo.AR_ASPECT_FIT_PARENT:
                    case com.grovertb.player.VideoInfo.AR_ASPECT_FILL_PARENT:
                    case com.grovertb.player.VideoInfo.AR_ASPECT_WRAP_CONTENT:
                    default:
