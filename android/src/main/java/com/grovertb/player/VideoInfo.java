...
public class VideoInfo implements Parcelable {
    ...
    private HashSet<com.grovertb.player.Option> options = new HashSet<>();
    ...
    public VideoInfo(VideoInfo defaultVideoInfo) {
        ...
        for (com.grovertb.player.Option op : defaultVideoInfo.options) {
            try {
    ...
    public HashSet<com.grovertb.player.Option> getOptions() {
        return options;
    }
     ...
     * @return VideoInfo
     */
    public VideoInfo addOption(com.grovertb.player.Option option) {
